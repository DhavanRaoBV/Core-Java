...
//		System.out.println(list1);
		...
		list2.add(new Employee(3, "Johny", 23423.2f));
		list2.add(new Employee(2, "Johnny", 36344.7f));

//		Collections.sort(list2, new IdSorter());
//		System.out.println(list2);
		
//		Collections.sort(list2, new SalarySort());
//		System.out.println(list2);
		
		Collections.sort(list2, new NameSort());
		System.out.println(list2);
